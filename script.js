...
xhr.open("GET", "https://marketplacerobo-6adc.restdb.io/rest/product");
xhr.setRequestHeader("content-type", "application/json");
xhr.setRequestHeader("x-apikey", "63a5f79cf43a573dae0956df");
...
orderForm.addEventListener("submit", function (event) {
    ...
    let xhr = new XMLHttpRequest();
    xhr.open("POST", "https://marketplacerobo-6adc.restdb.io/rest/product");
    xhr.setRequestHeader("content-type", "application/json");
    xhr.setRequestHeader("x-apikey", "63a5f79cf43a573dae0956df");
    xhr.setRequestHeader("cache-control", "no-cache");
    xhr.send(data);
